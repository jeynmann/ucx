...
protected:
    ...
    static void query_tx_token(uct_ep_h ep, __be32 *tx_token)
    {
        uct_ep_attr_t attr = {};
    ...
    static void
    query_rx_token(uct_iface_h iface, const __be32 *tx_token, __be32 *rx_token)
    {
        uct_iface_attr_v2_t attr = {};
    ...
    void check_token(const char *protocol)
    {
        ...
        EXPECT_EQ(ep->tx.wq.next_first_psn, be32toh(rx_token));
    }
};
